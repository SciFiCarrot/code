...
\pgfplotsset{
  compat=1.18,
  % project-wide defaults for consistent look
...
\usepackage[section]{placeins} % inserts \FloatBarrier before each \section
    ...
    % S2O32-
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                coordinates { (0.2, 0.0769) (0.15, 0.0581) (0.1, 0.0370) (0.05, 0.0187) };
